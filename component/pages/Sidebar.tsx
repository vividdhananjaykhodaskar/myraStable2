    ...
    <>
      ...
      >
        ...
        <ul className="py-6">
          ...
          {/* <li>
            <Link
              href="https://discord.gg/9mfyMc8y"
              target="_blank"
              className="flex items-center gap-3 text-white text-base underline"
            >
              <Image
                src="/discord.svg"
                alt=""
